...
if(isset($_POST['email'])) {
    ...
    if(!isset($_POST['first_name']) ||
        ...
        die('Lo sentimos, hay campos que deben ser llenados');
...
//Este es el cuerpo del mensaje tal y como llegará al correo
    ...
    $email_message .= "Nombre de la empresa: ".clean_string($first_name)."\n";

    $email_message .= "Nombre de contacto: ".clean_string($last_name)."\n";
