...
<html lang="es">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="vendor/bootstrap/css/bootstrap-material-design.min.css" rel="stylesheet">
    ...
    <body>
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav" style="background-color: #4284DA">
            <div class="container">
        ...
        <section class="page-section cta">                
            <div class="container">
                ...
                <div class="form-group; table-responsive; table-striped; table-dark">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align:center">
                                    <input class="btn btn-info btn-lg btn-raised" type="submit" value="Enviar">   <a href="http://as-card.com./email_form.php"></a>
                                </td>
                                </div>
                            </tr>
                        </table>
        ...
        <footer class="footer text-faded text-center py-5">
            ...
            <h3>
                ...
                <a href="https://www.instagram.com/ascardmx/" target="_blank"><i class="fab fa-instagram"></i>
                </a>
                <a href="https://www.youtube.com/channel/UCc4CtnX0hwTuHUK3UaX5MQg?view_as=subscriber" target="_blank"><i class="fab fa-youtube"></i></a>
            </h3>
        </footer>
