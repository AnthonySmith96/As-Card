...
$to = 	'anthonysmith@as-card.com';//set here your receiving mail address
$subject = 	'Tu diseño de As-Card'; //set here the mail subject
$bound_text = 	md5(date('r', time()));
$bound = 	"--".$bound_text."\r\n";
$bound_last = 	"--".$bound_text."--\r\n";

$headers = 	"From: anthonysmith@as-card.com\r\n";//set here the sending mail address
...
$message .= 	"Content-Type: text/html; charset=\"iso-8859-1\"\r\n"
  	...
  	."Esperamos que disfrutes de tu nueva As-Card pronto :D\r\n" //set here the mail text
  	.$bound;
